	...
	
{
	...
	public class BoardManager : MonoBehaviour
	{
		...
		public GameObject exit;											//Entrance to a dungeon
		public int columns = 5; 										//Number of columns in our game board.
		public int rows = 5;											//Number of rows in our game board.
		public GameObject[] outerWallTiles;								//Boundry walls of the dungeon
		public GameObject[] floorTiles;									//Array of floor prefabs.
		public GameObject[] wallTiles;									//Array of floor prefabs.
		private Transform boardHolder;									//A variable to store a reference to the transform of our Board object.
		private Dictionary<Vector2, Vector2> gridPositions = new Dictionary<Vector2, Vector2>();	//A list of possible locations to place tiles.
		private Transform dungeonBoardHolder;
		private Dictionary<Vector2, Vector2> dungeonGridPositions;		//Dictionary to hold the results from DungeonManager class
		 ...
		 public void SetDungeonBoard (Dictionary<Vector2,TileType>  dungeonTiles, int bound, Vector2 endPos) {
			...
			GameObject toInstantiate, instance;
 			...
 			foreach(KeyValuePair<Vector2,TileType> tile in dungeonTiles) {
				...
				instance = Instantiate (toInstantiate, new Vector3 
				(tile.Key.x, tile.Key.y, 0f), Quaternion.identity) as GameObject;
